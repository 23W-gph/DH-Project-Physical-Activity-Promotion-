...
ggplot(filtered_data, aes(x = Ethnicity, y = Percentage, fill = Ethnicity)) +
...
excel_file_path <- "C:/Users/Alexa/OneDrive/Desktop/Digital Health PA/R Intro/Physical_activity.xlsx"

write_xlsx(Physical_activity, excel_file_path)
